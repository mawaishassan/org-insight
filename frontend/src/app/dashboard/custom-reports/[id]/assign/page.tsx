...
function SingleCustomReportAssignRedirect() {
  ...
  useEffect(() => {
    ...
    q.set("tab", "resource");
    q.set("resource_type", "custom_report");
  ...
  return (
    <div style={{ maxWidth: 600, margin: "4rem auto", textAlign: "center", padding: "2rem" }}>
      ...
      <p style={{ color: "#64748b", fontSize: "0.875rem", marginBottom: "1.5rem" }}>
        Custom report access management has been unified into the centralized Access Management module.
      </p>
      {id && (
        <Link
          href={`/dashboard/access/rights?tab=resource&resource_type=custom_report&resource_id=${id}`}
          style={{
...
export default function CustomReportAssignPage() {
  return (
    <Suspense fallback={<div style={{ padding: "3rem", textAlign: "center" }}>Loading...</div>}>
      <SingleCustomReportAssignRedirect />
    </Suspense>
  );
}
